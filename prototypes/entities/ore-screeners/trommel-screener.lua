...
data:extend({
  {
    ...
    icon = "__hellscape-refining__/graphics/icons/trommel-screener.png",
    icon_size = 128,
    flags = {"placeable-neutral", "player-creation"},
    minable = {mining_time = 0.5, result = "trommel-screener"},
    crafting_categories = {
        "crafting",
    },
    max_health = 200,
    ...
    graphics_set = {
      animation = {
        layers = {
            {
            filename = "__hellscape-refining__/graphics/entity/trommel-screener/trommel-screener.png",
            width = 128,
            height = 128,
            frame_count = 1,
      ...
      working_visualisations = { {
        animation = {
            layers = {
                {
                filename = "__hellscape-refining__/graphics/entity/trommel-screener/trommel-screener-anim.png",
                width = 128,
                height = 128,
                frame_count = 4,
                animation_speed = 0.15,
